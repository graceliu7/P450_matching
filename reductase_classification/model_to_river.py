...
__all__ = ["convert_sklearn_to_river", "SKL2RiverClassifier", "SKL2RiverRegressor", "Multiflow2RiverClassifier"]


def convert_sklearn_to_river(
    estimator, classes: list = None
):
    ...
    if isinstance(estimator, skmultiflow.core.base.ClassifierMixin) and classes is None:
        raise ValueError("classes must be provided to convert a classifier")
    ...
    wrappers = [
        ...
        (
            ...
            functools.partial(Multiflow2RiverClassifier, classes=classes),
        )
    ]
...
class Multiflow2RiverClassifier(SKL2RiverBase, base.Classifier):
    """Compatibility layer from scikit-learn to River for classification.

    Parameters
    ----------
    estimator
        A scikit-multiflow regressor which has a `partial_fit` method.
    classes
    """

    def __init__(self, estimator: skmultiflow.core.base.ClassifierMixin, classes: list):
        super().__init__(estimator)
        self.classes = classes
